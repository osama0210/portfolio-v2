  ...
  const Hero = () => {
    return (
      <section
        id="hero"
        className="min-h-screen flex md:justify-center items-center px-10 md:px-12"
      >
        <div className="flex flex-col gap-4 animate-fade-in max-w-screen-md">
          ...
          <p className="text-base md:text-center text-black md:text-xl font-normal">
          ...
          <div className="flex justify-end md:justify-center my-5">
            <button
              ...
              className="bg-secondary inline-flex items-center gap-2 text-white text-base  md:text-lg px-6 py-2 rounded-lg shadow-md hover:shadow-lg hover:bg-secondary/90 transition"
            >
              See my work
